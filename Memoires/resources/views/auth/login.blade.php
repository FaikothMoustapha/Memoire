            ...
            <div class="container-fluid h-100">
                <div class="row flex-row h-100 bg-white">
                    <div class="col-xl-8 col-lg-6 col-md-5 p-0 d-md-block d-lg-block d-sm-none d-none">
                        <div class="lavalite-bg" style="background-image: url('../img/auth/j.jpg')">
                                ...
                                <div class="row">
                                    <div class="col text-left">
                                        <label class="custom-control custom-checkbox">
                                            ...
                                            <span class="custom-control-label">&nbsp;Restez connecter</span>
                                        </label>
                                    </div>
                                    <div class="col text-right">
                                        <a href="{{route('auth_forgot')}}">Mot de passe oublié ?</a>
                                    </div>
                                </div>
                                <div class="sign-btn text-center">
                                    <button class="btn btn-space btn-primary">Connexion</button>
                                </div>
                            </form>
