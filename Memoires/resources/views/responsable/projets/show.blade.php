            ...
            <form action="" method="POST">
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" name="objectifs" value="{{ $projets->objectifs }}" readonly>
                        <small class="text-danger">{{ $errors->first('objectifs') }}</small>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Résultats attendus</label>
                        <input type="text" class="form-control" name="resAttendu" value="{{ $projets->resAttendu }}" readonly>
